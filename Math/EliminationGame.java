 ...
 * 
 * 1. we first move from left, we definitely need to move head to next position. (head = head + step)
 ...
 * 
 * 2. second loop, we move from right, in what situation we need to move head?
