 ...
 * with equal probability 0.25. If the remaining volume of soup is not enough to complete the operation, we will serve as much as 
 * we can.  We stop once we no longer have some quantity of both types of soup.
 * 
...
public class SoupServings {
    ...
    public double helper(int a, int b) {
        ...
        dp[a][b] = 0.25 * (helper(a - 100, b) + helper(a - 75, b - 25) + helper(a - 50, b - 50) + helper(a - 25, b - 75));
        return d[a][b];
    }
}