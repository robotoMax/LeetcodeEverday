 ...
 */
/**
 * for every length subarray, we first define which value is the last to burst. And using that, we simulate the 
 * process of bursting. The for loop with variable k, is the process to try every number in that subarray as the 
 * last one to burst, and to get the local maximum.
 */
