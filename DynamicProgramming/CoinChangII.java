 ...
 */
/**
 * It's similar with 0/1 knapsack problem.
 * dp[i][j] represents that how many ways can be made up to j dollars using first i coins.
 * So there are two conditions: 
 * 1. Not using ith coin. Then it should be dp[i - 1][j];
 * 2. Using the ith coin. Then it should be dp[i][j - coins[i]]
 */
public class CoinChangeII {
    // using two dimensional dp array
