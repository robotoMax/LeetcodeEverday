 ...
 * 
 * Using the given numbers 1, 2 and 4, we can already build all sums from 0 to 7, i.e., the range [0,8). But we can't build the sum 8, and 
 * the next given number (13) is too large. So we insert 8 into the array. Then we can build all sums in [0,16).
 * 
 * Do we need to insert 16 into the array? No! We can already build the sum 3, and adding the given 13 gives us sum 16. We can also add 
 * the 13 to the other sums, extending our range to [0,29).
 * 
